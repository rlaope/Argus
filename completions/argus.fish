...
complete -c argus -n "__fish_seen_subcommand_from profile flame" -l threads -d 'Per-thread output'
complete -c argus -n "__fish_seen_subcommand_from profile flame" -l alluser -d 'Count only user-space events'
complete -c argus -n "__fish_seen_subcommand_from profile flame" -l allkernel -d 'Count only kernel-space events'
complete -c argus -n "__fish_seen_subcommand_from profile flame" -l alloc -d 'Allocation threshold (e.g. 128k)'
complete -c argus -n "__fish_seen_subcommand_from profile flame" -l live -d 'Only count live allocations'
complete -c argus -n "__fish_seen_subcommand_from profile flame" -l include -d 'Include frames matching pattern'
complete -c argus -n "__fish_seen_subcommand_from profile flame" -l exclude -d 'Exclude frames matching pattern'
complete -c argus -n "__fish_seen_subcommand_from flame" -l output -d 'Output file path'
complete -c argus -n "__fish_seen_subcommand_from flame" -l output-format -xa 'flamegraph collapsed jfr tree text' -d 'Output format'
complete -c argus -n "__fish_seen_subcommand_from flame" -l no-open -d 'Do not open browser'
