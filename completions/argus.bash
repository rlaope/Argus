_argus_completions() {
    ...
    commands="init ps histo threads gc gcutil heap sysprops vmflag nmt classloader profile jfr diff report info heapdump deadlock env compiler finalizer stringtable pool gccause metaspace dynlibs vmset vmlog jmx classstat gcnew symboltable top"
