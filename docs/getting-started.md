...
curl -fsSL https://raw.githubusercontent.com/rlaope/argus/master/install.sh | bash -s -- v1.0.0
```
...
curl -LO https://github.com/rlaope/argus/releases/latest/download/argus-agent-1.0.0.jar
curl -LO https://github.com/rlaope/argus/releases/latest/download/argus-cli-1.0.0-all.jar
```
...
# JARs:
# argus-agent/build/libs/argus-agent-1.0.0.jar
# argus-cli/build/libs/argus-cli-1.0.0-all.jar
```
...
# Or run directly
java -jar argus-cli/build/libs/argus-cli-1.0.0-all.jar --help
```
